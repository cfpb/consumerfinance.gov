  ...
  <form action="/search" data-js-hook="behavior_submit-search">
    <div class="o-search-input">
      <div class="o-search-input__input">
          ...
          <input type="search" id="query" name="q" value="money" class="a-text-input" placeholder="Enter your search term" title="Enter your search term" autocomplete="off" maxlength="75">
