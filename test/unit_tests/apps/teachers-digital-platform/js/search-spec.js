  ...
  <form class="tdp-activity-search" id="search-form" action="." data-js-hook="behavior_submit-search">
    <div class="o-search-input">
      <div class="o-search-input__input">
          ...
          <input type="search" id="search-text" name="q" value="executive" class="a-text-input" placeholder="Enter your search term(s)" title="Enter your search term(s)" autocomplete="off" maxlength="75">
