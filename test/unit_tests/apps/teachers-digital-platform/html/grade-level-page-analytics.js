...
<main class="content " id="main">
  <section data-tdp-page="grade-level" class="m-hero m-hero__bleeding tdp-survey" id="hero1">
    <div class="m-hero_wrapper wrapper">
      <div class="m-hero_text">
        <a data-tdp_grade_level="3-5" data-gtm_ignore="true" class="a-link
          a-link__jump
          a-link__icon-before-text" href="/consumer-tools/educator-tools/youth-financial-education/assess/survey/">
    ...
    <style>
      ...
      background-image:
      url('/static/apps/teachers-digital-platform/img/journey.png');
      ...
      .m-hero_image--mobile {
      background-image:
      url('/static/apps/teachers-digital-platform/img/journey-mobile.png');
      background-size: contain;
      padding-bottom: 59.459459459%;
      }
      }
    </style>
    <div class="o-modal" id="modal-privacy" tabindex="0" aria-hidden="true" role="alertdialog" aria-labelledby="modal-privacy_title" aria-describedby="modal-privacy_desc">
      ...
      <div class="o-modal_container">
        <div class="o-modal_content">
          <div class="o-modal_body">
            ...
            <h2 id="modal-privacy_title" class="h3">Privacy Notice</h2>
            <div id="modal-privacy_desc">
              <p>The Youth Financial Capability Assessment is provided by the Consumer Financial Protection
                Bureau (Bureau) as a financial education resource for parents, educators, and students. No
                information, including personally identifiable information (PII), will be collected by the Bureau.
                After completing assessment questions there is an optional feature to share assessment results,
                with the option to include the initials of your name when sharing the assessment results. If you
                choose to share assessment results, with or without your initials, this information will be
                transmitted but the Bureau will not collect, view, or maintain any of your PII.
              </p>
              <p>Using this tool and sharing assessment results is voluntary.</p>
            </div>
          </div>
