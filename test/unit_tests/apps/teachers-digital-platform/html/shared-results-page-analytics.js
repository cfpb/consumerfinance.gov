...
<main class="content content__2-1" id="main">
   <div class="content_wrapper tdp-survey" data-tdp_grade_level="9-12">
      <div data-tdp-page="results" data-grade-select-url="/consumer-tools/educator-tools/youth-financial-education/assess/survey/" class="content_main tdp-survey-results tdp-survey-results--shared">
         <p class="label">
            Your money journey results<span aria-hidden="false" style="" class="initials-display">: <span class="initials-value">NB</span></span>
         </p>
         ...
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 810 123">
            ...
            <image x="650" y="35" width="110px" height="75px" href="/static/apps/teachers-digital-platform/img/car.png"></image>
         </svg>
               ...
               <div class="o-modal_content">
                  <div class="o-modal_body">
                     ...
                     <div id="modal-share-url_desc">
                        ...
                        <div class="share-output" hidden="" data-signed-code="v1_9-12_11:1i:1e_5e9mi:-oddMwCmmuw6-4Z6KodHL_qE0iw">
                           <div>
         ...
         <div class="block">
            <p><strong>Now what?</strong> Review your results in more detail. Think about things you’re
               ...
               so you can see them again later or share them with your teacher or a trusted adult.
            </p>
         </div>
         ...
         <div class="o-expandable-group">
            <div class="o-expandable o-expandable__padded" data-js-hook="state_atomic_init">
               ...
               <div class="o-expandable_content o-expandable_content__transition u-is-animating o-expandable_content__expanded" style="max-height: 507px;">
                  <div class="tdp-survey-results__wrapper">
                     <span class="tdp-survey-results__marker starting-out">Starting out</span>
                     <span class="tdp-survey-results__marker on-the-road">On the road</span>
                     <span class="tdp-survey-results__marker well-on-your-way active">Well on your way</span>
                  ...
                  <div class="block">
                     <p>You’re <strong>well on your way</strong> to having strong planning and self-control skills! Planning ahead, remembering information, juggling tasks, and controlling impulses
                        are important skills for managing money.
                     </p>
                  </div>
            ...
            <div class="o-expandable o-expandable__padded" data-js-hook="state_atomic_init">
               ...
               <div class="o-expandable_content o-expandable_content__transition u-is-animating o-expandable_content__expanded" style="max-height: 529px;">
                  <div class="tdp-survey-results__wrapper">
                     <span class="tdp-survey-results__marker starting-out">Starting out</span>
                     <span class="tdp-survey-results__marker on-the-road active">On the road</span>
                     <span class="tdp-survey-results__marker well-on-your-way">Well on your way</span>
                  </div>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 810 123">
                     <g>
                        <g>
                     ...
                     <image x="500" y="35" width="110px" height="75px" href="/static/apps/teachers-digital-platform/img/car.png"></image>
                  </svg>
                  <div class="block">
                     <p>You’re <strong>on the road</strong> to developing stronger money habits and values! Money habits and values guide the way we spend and save money each day. These are the things we
         ...
         <div class="o-well block">
            ...
            <p>
               The
               <a class="a-link a-link__icon" href="https://files.consumerfinance.gov/f/documents/cfpb_building_block_activities_high-school-assessment-student-worksheet.pdf">
                  <span class="a-link_text">Taking the next steps on your money journey</span>
                  <svg class="cf-icon-svg" viewBox="0 0 12 19" xmlns="http://www.w3.org/2000/svg">
               ...
               worksheet can help you think about your strengths and set goals to get the money future you want.
            </p>
            ...
            <ul>
               <li>
                  <a class="a-link a-link__icon" href="https://files.consumerfinance.gov/f/documents/cfpb_building_block_activities_who-shapes-my-money-choices_handout.pdf">
                     <span class="a-link_text">Who shapes my money choices?</span>
                     <svg class="cf-icon-svg" viewBox="0 0 12 19" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.16 16.153a.477.477 0 0 1-.476.475H1.316a.476.476 0 0 1-.475-.475V3.046a.476.476 0 0 1 .475-.475h6.95l2.893 2.893zm-1.11-9.925H8.059a.575.575 0 0 1-.574-.573V3.679H1.95v11.84h8.102zm-1.234 5.604L6.388 14.26a.554.554 0 0 1-.784 0l-2.428-2.428a.554.554 0 1 1 .783-.784l1.483 1.482V7.41a.554.554 0 1 1 1.108 0v5.12l1.482-1.482a.554.554 0 0 1 .784.783z"></path>
                     </svg>
                  </a>
               ...
               <li>
                  <a class="a-link a-link__icon" href="https://files.consumerfinance.gov/f/documents/cfpb_building_block_activities_options-for-storing-savings_handout.pdf">
                     <span class="a-link_text">Options for storing your savings</span>
                     <svg class="cf-icon-svg" viewBox="0 0 12 19" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.16 16.153a.477.477 0 0 1-.476.475H1.316a.476.476 0 0 1-.475-.475V3.046a.476.476 0 0 1 .475-.475h6.95l2.893 2.893zm-1.11-9.925H8.059a.575.575 0 0 1-.574-.573V3.679H1.95v11.84h8.102zm-1.234 5.604L6.388 14.26a.554.554 0 0 1-.784 0l-2.428-2.428a.554.554 0 1 1 .783-.784l1.483 1.482V7.41a.554.554 0 1 1 1.108 0v5.12l1.482-1.482a.554.554 0 0 1 .784.783z"></path>
                     </svg>
                  </a>
               ...
               <li>
                  <a class="a-link a-link__icon" href="https://files.consumerfinance.gov/f/documents/cfpb_building_block_activities_all-about-FAFSA_handout.pdf">
                     <span class="a-link_text">All about the Free Application for Federal Student Aid (FAFSA)</span>
                     <svg class="cf-icon-svg" viewBox="0 0 12 19" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.16 16.153a.477.477 0 0 1-.476.475H1.316a.476.476 0 0 1-.475-.475V3.046a.476.476 0 0 1 .475-.475h6.95l2.893 2.893zm-1.11-9.925H8.059a.575.575 0 0 1-.574-.573V3.679H1.95v11.84h8.102zm-1.234 5.604L6.388 14.26a.554.554 0 0 1-.784 0l-2.428-2.428a.554.554 0 1 1 .783-.784l1.483 1.482V7.41a.554.554 0 1 1 1.108 0v5.12l1.482-1.482a.554.554 0 0 1 .784.783z"></path>
                     </svg>
                  </a>
         ...
         <div class="block block__padded-bottom block__border-bottom">
            ...
            <p>Keep in mind that managing money is a lifelong journey. Everyone, no matter their age, can always improve
               ...
               want. Come back and take the money journey survey again when you’re ready to check your progress.
            </p>
         </div>
         <div class="tdp-survey__save-block block">
            <div class="m-btn-group">
               <button type="button" class="a-btn" onclick="window.print()">
                  Print results
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 19" class="cf-icon-svg">
                     <path d="m8.698 2.358 3.065 3.066v1.95h.16a1.112 1.112 0 0 1 1.109 1.108v4.837a1.112 1.112 0 0 1-1.109 1.108h-.16v1.726a.477.477 0 0 1-.475.475H2.712a.477.477 0 0 1-.475-.475v-1.726h-.16A1.112 1.112 0 0 1 .968 13.32V8.482a1.112 1.112 0 0 1 1.109-1.108h.16v-4.54a.476.476 0 0 1 .475-.476zm-.22 3.876a.61.61 0 0 1-.608-.608v-2.16H3.345v3.908h7.31v-1.14zm2.177 4.512h-7.31v4.773h7.31zm-1.054.874h-5.26v1.109h5.26zm0 1.962h-5.26v1.108h5.26zm2.437-4.485a.554.554 0 1 0-.554.554.554.554 0 0 0 .554-.554z"></path>
                  </svg>
               </button>
               <a class="a-btn" href="/consumer-tools/save-as-pdf-instructions/" target="_blank">
                  How to save results
                  as a PDF
