...
<main class="content content__2-1" id="main">
   <div class="content_wrapper tdp-survey" data-tdp_grade_level="9-12">
      <div data-tdp-page="results" data-grade-select-url="/consumer-tools/educator-tools/youth-financial-education/assess/survey/" class="content_main tdp-survey-results">
         ...
         <div class="o-modal" id="modal-share-url" tabindex="0" aria-hidden="true" aria-labelledby="modal-share-url_title" aria-describedby="modal-share-url_desc">
            <div class="o-modal_backdrop"></div>
            <div class="o-modal_container">
               <div class="o-modal_content">
                  <span tabindex="0" data-trap="0" aria-hidden="true"></span>
                  ...
                  <span tabindex="0" data-trap="1" aria-hidden="true"></span>
               </div>
            </div>
         </div>
         ...
         <div class="tdp-survey__save-block block">
            ...
            <div class="m-btn-group">
               ...
               <button type="button" class="a-btn" data-open-modal="modal-share-url">
                  Share results
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 19" class="cf-icon-svg">
                     <path d="M14.395 14.803a2.64 2.64 0 1 1-5.118-.91l-4.093-2.589a2.645 2.645 0 1 1 0-3.608l4.093-2.588a2.644 2.644 0 1 1 .593.936L5.755 8.646a2.659 2.659 0 0 1 0 1.707l4.115 2.603a2.64 2.64 0 0 1 4.525 1.847z"></path>
                  </svg>
               </button>
            </div>
         </div>
