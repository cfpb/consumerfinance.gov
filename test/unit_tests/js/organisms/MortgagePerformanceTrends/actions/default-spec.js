...
import * as defaultActionCreators from '../../../../../../unprocessed/js/organisms/MortgagePerformanceTrends/actions/default.js';
const actions = defaultActionCreators.default();

jest.mock( 'xdr', () => jest.fn( () => ( { mock: 'data' } ) ) );
jest.mock( '../../../../../../unprocessed/js/organisms/MortgagePerformanceTrends/utils', () => ( {
  getNonMetroData: cb => {
    const nonMetros = [ {
      valid: true,
      fips: '12345',
