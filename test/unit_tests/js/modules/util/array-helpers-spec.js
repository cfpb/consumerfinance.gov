import {
  indexOfObject,
  uniquePrimitives,
} from '../../../../../cfgov/unprocessed/js/modules/util/array-helpers';
let array;
let index;
...
describe('array-helpers', () => {
  describe('indexOfObject()', () => {
    ...
    it('should return -1 if there is no match', () => {
      ...
      index = indexOfObject(array, 'value', 'foo');
  ...
  describe('uniquePrimitives()', () => {
    it('should return an array without duplicate primitives', () => {
      ...
      const newArr = uniquePrimitives(testArray);
