...
describe( 'Validators', () => {
  ...
  describe( 'checkbox field', () => {
    ...
    it(
      ...
      () => {
        const fieldset = [ document.createElement( 'input' ) ];
        returnedObject = validators.checkbox( testField, null, fieldset );

        expect( returnedObject['checkbox'] ).toBe( false );
        expect( returnedObject['msg'] ).toBe(
          ERROR_MESSAGES.CHECKBOX.REQUIRED.replace( '%s', '2' )
        );
      }
    );
  ...
  describe( 'radio field', () => {
    ...
    it(
      ...
      () => {
        ...
        expect( returnedObject['msg'] ).toBe(
          ERROR_MESSAGES.CHECKBOX.REQUIRED.replace( '%s', '1' )
        );
      }
    );
