...
describe('Dynamic Disclosures', () => {
  ...
  beforeEach(() => {
    ...
    cy.intercept( 'GET', apiSchoolTwo, {fixture: 'paying-for-college/school-224776.json'}).as('intSchoolTwo');
    cy.intercept( 'GET', apiProgramOne, {fixture: 'paying-for-college/program-133465_5287.json'}).as('intProgramOne');
    cy.intercept( 'GET', apiProgramTwo, {fixture: 'paying-for-college/program-224776_444.json'}).as('intProgramTwo');
    cy.visit( urlOne );
