      ...
      desktops.forEach((desktop) => {
        context(desktop, () => {
          ...
          it('should highlight the current section', () => {
            fig.goToSection(2);
            fig.getNavItem(2).should('have.class', 'o-secondary-nav_link__current');
            fig.getNavItem(1).should('not.have.class', 'o-secondary-nav_link__current');
            fig.getNavItem(3).should('not.have.class', 'o-secondary-nav_link__current');
            fig.getNavItem(4).should('not.have.class', 'o-secondary-nav_link__current');
          });
          ...
          it('should highlight correction section when clicking heading', () => {
            ...
            fig.getNavItem(1).should('have.class', 'o-secondary-nav_link__current');
            fig.getNavItem('credit-type').should('not.be.visible');

            fig.clickSectionHeading(3);
            fig.getNavItem(3).should('have.class', 'o-secondary-nav_link__current');
            fig.getNavItem('credit-type').should('be.visible');
            ...
            fig.getNavItem(5).should('have.class', 'o-secondary-nav_link__current');
            fig.getNavItem('credit-type').should('not.be.visible');
