...
var WagtailAdminPagesPage = require( '../../page_objects/wagtail-admin-pages-page.js' );
var wagtailAdminPagesPage = new WagtailAdminPagesPage();
...
defineSupportCode( function( { Then, When } ) {
  ...
  Then( /I select the (.*) (?: atom|molecule|organism|element)/, function ( component ) {
