...
[this script](https://github.com/cfpb/consumerfinance.gov/blob/master/docker/deployable-zipfile/_build.sh)),
...
as a Python module](https://github.com/cfpb/consumerfinance.gov/blob/master/cfgov/deployable_zipfile/extract.py).
