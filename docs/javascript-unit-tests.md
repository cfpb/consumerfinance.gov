...
- [All unit tests](https://github.com/cfpb/consumerfinance.gov/tree/master/test/unit_tests)
- [Tests for individual apps](https://github.com/cfpb/consumerfinance.gov/tree/master/test/unit_tests/apps)
- [Tests for regular modules](https://github.com/cfpb/consumerfinance.gov/tree/master/test/unit_tests/js/modules)
- [Tests for molecules](https://github.com/cfpb/consumerfinance.gov/tree/master/test/unit_tests/js/molecules)
- [Tests for organisms](https://github.com/cfpb/consumerfinance.gov/tree/master/test/unit_tests/js/organisms)
...
[`test/unit_tests/`](https://github.com/cfpb/consumerfinance.gov/tree/master/test/unit_tests)
directory.

The folder structure of the test files mirrors
the structure of the project JavaScript in
[`cfgov/unprocessed/js/`](https://github.com/cfpb/consumerfinance.gov/tree/master/cfgov/unprocessed/js).
...
1. Make the test pass by changing your script’s line 7
   ([see `sample.js`](https://github.com/cfpb/consumerfinance.gov/blob/master/cfgov/unprocessed/js/modules/sample.js))
   to the following:
...
Another example is
[`breakpoint-state-spec.js`](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/modules/util/breakpoint-state-spec.js),
...
[strings-spec.js](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/modules/util/strings-spec.js).
...
[`Analytics-spec.js`](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/modules/Analytics-spec.js#L7-L32)
...
e.g., the tests in
[`footer-button-spec.js`](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/modules/footer-button-spec.js).
Use `beforeEach` to reset manipulated markup between tests, e.g., the tests in
[`Notification-spec.js`](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/molecules/Notification-spec.js).
...
[array helpers module](https://github.com/cfpb/consumerfinance.gov/blob/master/cfgov/unprocessed/js/modules/util/array-helpers.js)
...
[test/unit_tests/js/modules/util/array-helpers-spec.js](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/modules/util/array-helpers-spec.js):
...
[the component JS](https://github.com/cfpb/consumerfinance.gov/blob/master/cfgov/unprocessed/js/molecules/Notification.js),
...
[the spec file](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/molecules/Notification-spec.js)
...
[the tests for our full-table-row-linking code](https://github.com/cfpb/consumerfinance.gov/blob/master/test/unit_tests/js/modules/o-table-row-links-spec.js).

In
[the module code](https://github.com/cfpb/consumerfinance.gov/blob/master/cfgov/unprocessed/js/modules/o-table-row-links.js)
