...
["StreamField blocks"](https://docs.wagtail.io/en/v2.3/topics/streamfield.html)*
(or just "blocks").
...
[`StructBlock`](http://docs.wagtail.io/en/v2.3/topics/streamfield.html#structblock).
...
1. The `RelatedContent` class is a subclass of
   [Wagtail's `StructBlock`](https://docs.wagtail.io/en/v2.3/topics/streamfield.html#structblock),
...
2. The `heading` field uses the basic Wagtail
   [`CharBlock`](https://docs.wagtail.io/en/v2.3/topics/streamfield.html#charblock),
   which results in a field with a basic single-line text input.
3. The `paragraph` field uses the basic Wagtail
   [`RichTextBlock`](https://docs.wagtail.io/en/v2.3/topics/streamfield.html#richtextblock),
   which results in a field with a multiline WYSIWYG text input.
4. The `links` field uses another basic Wagtail block,
   [`ListBlock`](https://docs.wagtail.io/en/v2.3/topics/streamfield.html#listblock),
...
1. [Overriding the default `get_context` method](http://docs.wagtail.io/en/v2.3/topics/streamfield.html#streamfield-get-context)
...
1. Add the field by inserting a snippet like this in the list of fields,
   ...
   `field_name = blocks.BlockName()`.
    ...
    - Replace `BlockName` with one of the
      [basic Wagtail block types](https://docs.wagtail.io/en/v2.3/topics/streamfield.html#basic-block-types).
...
1. Add any desired parameters:
    ...
    - Certain blocks may take other arguments, as described in the
      [basic Wagtail blocks documentation](https://docs.wagtail.io/en/v2.3/topics/streamfield.html#basic-block-types).
