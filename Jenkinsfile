            ...
            steps {
                ...
                script {
                    ...
                    timeout(time: 25, unit: 'MINUTES') {
                        ...
                        // docker.run("${env.CYPRESS_E2E} --spec '${env.CYPRESS_PATH}/pages/*'")
                        sh "pip install --no-cache-dir -U pip;pip install --no-cache-dir -U docker-compose;docker-compose -f docker-compose.e2e.yml up ${env.CYPRESS_ENV} ${env.CYPRESS_VOLUMES}"
