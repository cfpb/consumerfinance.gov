            ...
            steps {
                ...
                script {
                    ...
                    timeout(time: 60, unit: 'MINUTES') {
                        ...
                        sh "docker run -u ${HOST_UID_GID} -v ${WORKSPACE}/test/cypress:/app/test/cypress -v ${WORKSPACE}/cypress.json:/app/cypress.json -w /app -e CYPRESS_baseUrl=https://${CFGOV_HOSTNAME} -e CI=1 cypress/included:6.8.0 npx cypress run -b chrome --headless"
                    }
                }
