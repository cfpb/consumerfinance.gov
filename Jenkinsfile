            ...
            steps {
                ...
                script {
                    ...
                    timeout(time: 15, unit: 'MINUTES') {
                        ...
                        sh "docker run -v ${WORKSPACE}/test/cypress:/app/test/cypress -v ${WORKSPACE}/cypress.json:/app/cypress.json -v ${WORKSPACE}/package.json:/app/package.json -v ${WORKSPACE}/node_modules:/app/node_modules -w /app -e CYPRESS_baseUrl=https://${CFGOV_HOSTNAME} -e CI=1 cypress/included:6.4.0 npx cypress run -b chrome --headless"
                    }
                }
