...
import requests
from college.disclosures.scripts import api_utils
from college.disclosures.scripts.api_utils import MODEL_MAP
from college.models import CONTROL_MAP, School
