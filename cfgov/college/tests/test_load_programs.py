...
import mock
from college.disclosures.scripts.load_programs import (
...
class TestLoadPrograms(django.test.TestCase):
    ...
    def setUp(self):
        print_patch = mock.patch(
            'college.disclosures.scripts.load_programs.print'
        )
        print_patch.start()
    ...
    @patch(
        'college.disclosures.scripts.load_programs.requests.get')
    ...
    @patch(
        'college.disclosures.scripts.load_programs.read_in_s3')
    ...
    @patch(
        'college.disclosures.scripts.load_programs.read_in_data')
    @patch(
        'college.disclosures.scripts.load_programs.clean')
    @patch(
        'college.disclosures.scripts.'
