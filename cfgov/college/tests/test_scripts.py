...
import requests
from college.disclosures.scripts import (
    api_utils, nat_stats, notifications, purge_objects, tag_settlement_schools,
    update_colleges, update_ipeds
)
from college.disclosures.scripts.ping_edmc import (
    EDMC_DEV, ERRORS, OID, notify_edmc
)
from college.models import Alias, Notification, Program, School
...
class TaggingTests(django.test.TestCase):
    ...
    @mock.patch('college.disclosures.scripts.'
...
class TestScripts(django.test.TestCase):
    ...
    def setUp(self):
        for method in ('print', 'sys.stdout'):
            base = 'college.disclosures.scripts.update_colleges.'
    ...
    @patch(
        'college.disclosures.scripts.update_colleges.requests.get')
    ...
    @patch('college.disclosures.scripts.update_ipeds.create_alias')
    ...
    @patch(
        'college.disclosures.scripts.update_ipeds.process_datafiles')  # noqa
    @patch('college.disclosures.scripts.update_ipeds.dump_csv')
    @patch('college.disclosures.scripts.update_ipeds.create_school')
    ...
    @patch(
        'college.disclosures.scripts.update_ipeds.download_files')
    ...
    @patch('college.disclosures.scripts.update_ipeds.read_csv')
    @patch(
        'college.disclosures.scripts.update_ipeds.write_clean_csv')
    ...
    @patch('college.disclosures.scripts.update_ipeds.unzip_file')
    @patch('college.disclosures.scripts.update_ipeds.call')
    ...
    @patch(
        'college.disclosures.scripts.update_ipeds.download_zip_file')  # noqa
    @patch(
        'college.disclosures.scripts.update_ipeds.clean_csv_headings')  # noqa
    ...
    @patch(
        'college.disclosures.scripts.update_ipeds.process_datafiles')  # noqa
    @patch(
        'college.disclosures.scripts.update_ipeds.process_missing')
    ...
    @patch('college.disclosures.scripts.notifications.send_mail')
    ...
    @patch(
        'college.disclosures.scripts.notifications'
    ...
    @patch('college.disclosures.scripts.ping_edmc.requests.post')
    ...
    @patch('college.disclosures.scripts.api_utils.requests.get')
    ...
    @patch('college.disclosures.scripts.nat_stats.requests.get')
    ...
    @patch('college.disclosures.scripts.nat_stats.yaml.safe_load')
    @patch('college.disclosures.scripts.nat_stats.requests.get')
    ...
    @patch('college.disclosures.scripts.nat_stats.get_stats_yaml')
    ...
    @patch(
        'college.disclosures.scripts.nat_stats'
