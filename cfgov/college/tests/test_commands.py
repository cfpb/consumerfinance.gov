...
class CommandTests(unittest.TestCase):
    ...
    @mock.patch('college.management.commands.purge.purge')
    ...
    @mock.patch(
        'college.management.commands.update_ipeds.load_values')
    ...
    @mock.patch('college.management.commands.'
