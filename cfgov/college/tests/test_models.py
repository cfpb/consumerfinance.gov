...
class CollegeConfigTest(unittest.TestCase):

    def test_app_config(self):
        self.assertEqual(CollegeConfig.name, 'college')


class ComparisonModelTest(TestCase):

    def test_comparisons(self):
        from college.models import comparisons
        self.assertIn('unicode_literals', dir(comparisons))
...
class SchoolModelsTest(TestCase):
    ...
    @mock.patch('college.models.disclosures.requests.get')
    ...
    @mock.patch('college.models.disclosures.send_mail')
    ...
    @mock.patch('college.models.disclosures.requests.post')
