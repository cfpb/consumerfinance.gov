...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ('regulations3k', '0033_edit_validator_warnings'),
        ('regulations3k', '0034_design_system_links'),
        ...
        ('regulations3k', '0039_add_aria_label_to_hyperlinks'),
        ('regulations3k', '0040_add_default_empty_list_for_213_prep'),
        ('regulations3k', '0041_update_help_text_on_info_unit_group_intro_text'),
        ('regulations3k', '0042_add_ask_search_max_length'),
        ('regulations3k', '0043_image_alt_no_limit'),

    ]

    dependencies = [
        ('regulations3k', '0044_2022_reset'),
        ('v1', '0284_2022_reset'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(wagtailsharing.models.ShareableRoutablePageMixin, ask_cfpb.models.pages.SecondaryNavigationJSMixin, 'v1.cfgovpage'),
        ),
        migrations.AddField(
