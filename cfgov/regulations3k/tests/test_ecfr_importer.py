...
class AppendixNamingTestCase(unittest.TestCase):
    ...
    def test_get_appendix_label_default(self):
        self.assertEqual(ecfr_importer.get_appendix_label(
            '', 'unhelpful head', 'Z'),
            'Z')
...
class ParagraphParsingTestCase(unittest.TestCase):
    ...
    def test_get_interp_section_tag(self):
        ...
        self.assertEqual(
            ecfr_importer.get_interp_section_tag(headline), 'A')
        headline = 'Appendices G and H - A dreaded Combo Appendix Section'
        self.assertEqual(
            ecfr_importer.get_interp_section_tag(headline), 'GH')
        headline = 'Introduction'
        self.assertEqual(
            ecfr_importer.get_interp_section_tag(headline), '0')
        headline = 'Appendix MS-3 - Model Force-Placed Insurance Notice Forms'
        self.assertEqual(
            ecfr_importer.get_interp_section_tag(headline), 'MS3')
