...
class RedirectRegulations3kTestCase(TestCase):
    def setUp(self):
        ...
        self.test_reg_1002 = baker.make(Part, part_number="1002")

        self.test_reg_1005 = baker.make(Part, part_number="1005")
    ...
    def test_redirect_invalid_part(self):
        request = self.factory.get("/eregulations/1020-1/2017-20417_20180101")
        response = redirect_eregs(request)
        self.assertEqual(
            response.get("location"),
            "/policy-compliance/rulemaking/regulations/",
    ...
    def test_redirect_invalid_part_pattern(self):
        request = self.factory.get("/eregulations/102/")
        response = redirect_eregs(request)
        self.assertEqual(
            response.get("location"),
            "/policy-compliance/rulemaking/regulations/",
    ...
    def test_redirect_past_version(self):
        request = self.factory.get("/eregulations/1002-1/2016-16301")
        response = redirect_eregs(request)
        self.assertEqual(
            response.get("location"),
    ...
    def test_redirect_past_version_not_live(self):
        request = self.factory.get("/eregulations/1002-1/2013-22752_20140110")
        response = redirect_eregs(request)
        self.assertEqual(
            response.get("location"),
            "/policy-compliance/rulemaking/regulations/1002/1/",
    ...
    def test_redirect_interp_intro_bad_version(self):
        request = self.factory.get("/eregulations/1030-Interp-h1/2011-31727")
        response = redirect_eregs(request)
        self.assertEqual(
            response.get("location"),
    ...
    def test_redirect_no_pattern_match_after_part(self):
        ...
        request = self.factory.get("/eregulations/1002/9999/")
        response = redirect_eregs(request)
        self.assertEqual(
            response.get("location"),
            "/policy-compliance/rulemaking/regulations/1002/",
