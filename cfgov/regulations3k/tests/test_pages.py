...
class PagesRegulations3kTestCase(TestCase):
    def setUp(self):
        ...
        self.subpart = baker.make(
            Subpart, label="1002", title="", version=self.effective_version
        )
    ...
    def test_redirect_uppercase(self):
        response = self.client.get("/reg-landing/1002/Interp-2/")
    ...
    def test_invalid_effective_date(self):
        ...
        # It should 404.
        response = self.client.get("/reg-landing/1002/2014-18-01/")
