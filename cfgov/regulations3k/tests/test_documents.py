...
class SectionParagraphDocumentTest(TestCase):
    ...
    def test_prepare(self):
        part = Part(cfr_title_number="0001", chapter="1", part_number="1234", title="Test Title", short_name="short name")
        ...
        section = Section(label="Section Label", title="Section Title", subpart=subpart, sortable_label="Sortable Label")
        section_paragraph = SectionParagraph(paragraph="Paragraph", paragraph_id="1", section=section)
