...
from regulations3k.regparser.patterns import title_pattern
...
class PayLoad(object):
    ...
    def reset(self):
        self.interp_refs = {}
        self.tables = {}
        for element in [self.effective_date,
                        self.part,
                        self.version,
    ...
    def get_effective_date(self, part_number):
        ...
        date_strings = [result['effective_on']
                        for result in FR_json['results']]
        dates = sorted(set(
