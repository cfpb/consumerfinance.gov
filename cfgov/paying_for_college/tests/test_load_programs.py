...
class TestLoadPrograms(django.test.TestCase):
    ...
    @patch("paying_for_college.disclosures.scripts.load_programs.requests.get")
    def test_read_in_s3(self, mock_requests):
        mock_requests.return_value.text = "a,b,c\nd,e,\u201c"
    ...
    @patch("paying_for_college.disclosures.scripts.load_programs.read_in_s3")
    ...
    @patch("paying_for_college.disclosures.scripts.load_programs.read_in_data")
    @patch("paying_for_college.disclosures.scripts.load_programs.clean")
    @patch(
        "paying_for_college.disclosures.scripts."
    ...
    def test_load(self, mock_get_or_create_program, mock_clean, mock_read_in):
        ...
        self.assertEqual(
            program.program_name, "Occupational Therapy Assistant - 981 - Test"
        )
        ...
        self.assertEqual(
            mock_get_or_create_program.call_count, 1
        )  # loader bails before creating program
