# Generated by Django 2.2.12 on 2020-06-09 14:39
...
def migrate_forwards(apps, schema_editor):
    migrate_page_types_and_fields(
        apps,
        [
            ('paying_for_college', page_type, 'header', 'featured_content')
            for page_type in (
                'CollegeCostsPage',
