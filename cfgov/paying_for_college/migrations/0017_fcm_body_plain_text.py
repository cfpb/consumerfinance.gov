# Generated by Django 2.2.16 on 2021-01-15 17:51
...
def mapper(page_or_revision, value):
    ...
    if body:
        value['body'] = strip_tags(body).strip()
...
def migrate_forwards(apps, schema_editor):
    migrate_page_types_and_fields(
        apps,
        [
            ('paying_for_college', page_type, field, 'featured_content')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('paying_for_college', '0016_design_system_links'),
    ]
