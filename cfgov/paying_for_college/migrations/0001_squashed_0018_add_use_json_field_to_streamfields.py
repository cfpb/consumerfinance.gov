# Generated by Django 3.2.18 on 2023-05-04 14:47
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contacts",
                    models.TextField(
                        blank=True, help_text="COMMA-SEPARATED LIST OF EMAILS"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "avg_net_price",
                    models.IntegerField(
                        blank=True, help_text="OVERALL AVERAGE", null=True
                    ),
                ),
                (
                    "avg_net_price_slices",
                    models.JSONField(blank=True, null=True),
                ),
                (
                ...
                (
                    "cohort_ranking_by_control",
                    models.JSONField(blank=True, null=True),
                ),
                (
                    "cohort_ranking_by_highest_degree",
                    models.JSONField(blank=True, null=True),
                ),
                (
                    "cohort_ranking_by_state",
                    models.JSONField(blank=True, null=True),
                ),
                (
                    "associate_transfer_rate",
                    models.DecimalField(
                        blank=True,
                        decimal_places=3,
                        help_text="Transfer rate for first-time, full-time students at less-than-four-year institutions (150% of expected time to completion)",
                        max_digits=5,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_cost",
                    models.IntegerField(
                        blank=True, help_text="COMPUTED", null=True
                    ),
                ),
                (
                    "time_to_complete",
                    models.IntegerField(
                        blank=True, help_text="IN MONTHS", null=True
                    ),
                ),
                (
                    "completion_rate",
                ...
                (
                    "completion_cohort",
                    models.IntegerField(
                        blank=True, help_text="COMPLETION COHORT", null=True
                    ),
                ),
                (
                    "completers",
                ...
                (
                    "salary",
                    models.IntegerField(
                        blank=True, help_text="MEDIAN SALARY", null=True
                    ),
                ),
                (
                    "program_length",
                ...
                (
                    "housing",
                    models.IntegerField(
                        blank=True, help_text="HOUSING & MEALS", null=True
                    ),
                ),
                (
                    "books",
                    models.IntegerField(
                        blank=True, help_text="BOOKS & SUPPLIES", null=True
                    ),
                ),
                                    ...
                                    [
                                        (
                                            ...
                                            wagtail.blocks.CharBlock(
                                                help_text='For complete guidelines on creating heroes, visit our <a href="https://cfpb.github.io/design-system/components/heroes">Design System</a>. Character counts (including spaces) at largest breakpoint:<ul class="help">    <li>&bull; 41 characters max (one-line heading)</li>    <li>&bull; 82 characters max (two-line heading)</li></ul>',
                                                required=False,
                                            ),
                                        ),
                                        (
                                            ...
                                            wagtail.blocks.RichTextBlock(
                                                help_text='Character counts (including spaces) at largest breakpoint:<ul class="help">    <li>&bull; 165-186 characters (after a one-line heading)</li>    <li>&bull; 108-124 characters (after a two-line heading)</li></ul>',
                                                label="Sub-heading",
                                                required=False,
                                            ),
                                        ),
                                        (
                                            ...
                                            wagtail.images.blocks.ImageChooserBlock(
                                                help_text='When saving illustrations, use a transparent background. <a href="https://cfpb.github.io/design-system/components/heroes#style">See image dimension guidelines.</a>',
                                                label="Large image",
                                                required=False,
                                            ),
                                        ),
                                        (
                                            "small_image",
                                            wagtail.images.blocks.ImageChooserBlock(
                                                help_text='<b>Optional.</b> Provides an alternate image for small displays when using a photo or bleeding hero. Not required for the standard illustration. <a href="https://cfpb.github.io/design-system/components/heroes#style">See image dimension guidelines.</a>',
                                                required=False,
                                            ),
                                        ),
                                        (
                                            "background_color",
                                            wagtail.blocks.CharBlock(
                                                help_text='Specify a hex value (including the # sign) from our <a href="https://cfpb.github.io/design-system/foundation/color">official color palette</a>.',
                                                required=False,
                                            ),
                                        ),
                                        (
                                            ...
                                            wagtail.blocks.BooleanBlock(
                                                help_text="<b>Optional.</b> Turns the hero text white. Useful if using a dark background color or background image.",
                                                label="White text",
                                                required=False,
                                            ),
                                        ),
                                        (
                                            "is_overlay",
                                            wagtail.blocks.BooleanBlock(
                                                help_text='<b>Optional.</b> Uses the large image as a background under the entire hero, creating the "Photo" style of hero (see <a href="https://cfpb.github.io/design-system/components/heroes">Design System</a> for details). When using this option, make sure to specify a background color (above) for the left/right margins that appear when screens are wider than 1200px and for the text section when the photo and text stack at mobile sizes.',
                                                label="Photo",
                                                required=False,
                                            ),
                                        ),
                                        (
                                            "is_bleeding",
                                            wagtail.blocks.BooleanBlock(
                                                help_text="<b>Optional.</b> Select if you want the illustration to bleed vertically off the top and bottom of the hero space.",
                                                label="Bleed",
                                                required=False,
                                            ),
                                        ),
                                            ...
                                            wagtail.blocks.StructBlock(
                                                [
                                                    (
                                                        "shareable",
                                                        wagtail.blocks.BooleanBlock(
                                                            help_text="If checked, share links will be included below the items.",
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        (
                                            "heading",
                                            wagtail.blocks.CharBlock(
                                                help_text="Added as an <code>&lt;h3&gt;</code> at the top of this block. Also adds a wrapping <code>&lt;div&gt;</code> whose <code>id</code> attribute comes from a slugified version of this heading, creating an anchor that can be used when linking to this part of the page.",
                                                required=False,
                                            ),
                                        ),
                                        (
                                                                                        ...
                                                                                        wagtail.blocks.StructBlock(
                                                                                            [
                                                                                                ...
                                                                                                (
                                                                                                    "vanity",
                                                                                                    wagtail.blocks.CharBlock(
                                                                                                        help_text="A phoneword version of the above number. Include any formatting. Ex. (555) 222-CFPB",
                                                                                                        max_length=15,
                                                                                                        required=False,
                                                                                                    ),
                                                                                                ),
