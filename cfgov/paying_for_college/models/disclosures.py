...
NOTIFICATION_TEMPLATE = Template(
    """Disclosure notification for offer ID $oid\n\
    timestamp: $time\n\
    errors: $errors\n\
...
class ConstantRate(models.Model):
    ...
    slug = models.CharField(
        max_length=255, blank=True, help_text="VARIABLE NAME FOR JS"
    )
...
class School(models.Model):
    ...
    under_investigation = models.BooleanField(
        default=False, help_text="Heightened Cash Monitoring 2"
    )
    ...
    median_annual_pay = models.IntegerField(
        blank=True, null=True, help_text=("MEDIAN PAY 10 YRS AFTER ENTRY")
    )
    median_annual_pay_6yr = models.IntegerField(
        blank=True, null=True, help_text=("MEDIAN PAY 6 YRS AFTER ENTRY")
    )
    avg_net_price = models.IntegerField(
        blank=True, null=True, help_text="OVERALL AVERAGE"
    )
    ...
    def program_codes(self):
        ...
        program_sets = {"graduate": graduate, "undergrad": undergrad}
