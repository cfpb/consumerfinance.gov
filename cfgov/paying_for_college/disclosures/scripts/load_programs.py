...
class ProgramSerializer(serializers.Serializer):
    ...
    median_salary = serializers.IntegerField(
    ...
    job_placement_rate = serializers.FloatField(
        allow_null=True, required=False
    )  # 0.7
    ...
    cip_code = serializers.CharField(
        allow_blank=True, required=False
    )  # '12.0504'
...
def clean(data):
    ...
    cleaned_data["ope_id"] = (
        cleaned_data["ope_id"].replace("-", "").replace(" ", "")
    )
