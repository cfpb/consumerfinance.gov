# Generated by Django 3.2.23 on 2024-01-09 16:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ask_cfpb', '0002_deprecate_super_button'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='answerpage',
            name='last_edited',
            field=models.DateField(blank=True, help_text='If content is changed, update this to match the new publication date.', null=True),
        ),
        migrations.AlterField(
            model_name='answerpage',
            name='portal_category',
            field=modelcluster.fields.ParentalManyToManyField(blank=True, help_text='Determined where this page can be found within selected Consumer Tools pages.', to='v1.PortalCategory'),
        ),
        migrations.AlterField(
            model_name='answerpage',
            name='portal_topic',
            field=modelcluster.fields.ParentalManyToManyField(blank=True, help_text='Adds this question to search indexes for selected Consumer Tools pages.', to='v1.PortalTopic'),
        ),
        migrations.AlterField(
            model_name='answerpage',
            name='primary_portal_topic',
            field=modelcluster.fields.ParentalKey(blank=True, help_text='Use only when more than one Consumer Tools page is selected above.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='primary_portal_topic', to='v1.portaltopic'),
        ),
        migrations.AlterField(
            model_name='answerpage',
            name='question',
            field=models.TextField(blank=True, help_text='Used as the primary heading (H1) of the page.'),
        ),
        migrations.AlterField(
            model_name='answerpage',
            name='related_questions',
            field=modelcluster.fields.ParentalManyToManyField(blank=True, help_text='Select no more than three.', related_name='related_question', to='ask_cfpb.AnswerPage'),
        ),
        migrations.AlterField(
            model_name='answerpage',
            name='short_answer',
            field=wagtail.fields.RichTextField(blank=True, help_text='Formatted as a lead paragraph.'),
        ),
        migrations.AlterField(
            model_name='answerpage',
            name='sidebar',
