...
class CompanyInfoForm(forms.Form):
    ...
    def save(self):
        ...
        company_info_data['tax_id'] = "{company_tax_id1}-{company_tax_id2}" .format(**form_data)
        company_info_data['website'] = form_data['company_website']
        company_info_data['company_phone'] = "{company_phone1}-{company_phone2}-{company_phone3}".format(**form_data)
        ...
        company_info_data['contact_phone'] = "{poc_phone1}-{poc_phone2}-{poc_phone3}".format(**form_data)
