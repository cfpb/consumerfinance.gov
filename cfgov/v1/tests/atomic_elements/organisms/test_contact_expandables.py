    ...
    def test_render(self):
        ...
        html = block.render(
            block.to_python(
                {
                    "heading": "Contacts",
                    "expandables": [{"contact": pk} for pk in (5, 3, 2, 1, 8)],
                }
            )
        )
        ...
        self.assertInHTML(
            '<a href="https://8.example.com">https://8.example.com</a>', html
        )
            ...
            [
                ...
                },
                {
                    ...
                    "value": {
                        "heading": "Second",
                        "expandables": [
                            {"contact": pk} for pk in reversed(range(5, 10))
                        ],
                    },
                },
            ],
