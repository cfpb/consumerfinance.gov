...
class TestFilterableList(TestCase):
    ...
    def set_up_published_pages(self):
        ...
        page1.tags.add("C-tag-3-instances")

        page2 = EventPage(title="test page 2", start_dt=datetime.now(timezone("UTC")))
        page2.tags.add("B-tag-2-instances")
        page2.tags.add("C-tag-3-instances")

        page3 = BlogPage(title="test page 3")
        page3.tags.add("A-tag-1-instance")
        page3.tags.add("B-tag-2-instances")
        page3.tags.add("C-tag-3-instances")
