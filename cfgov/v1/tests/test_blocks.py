...
class TestAbstractFormBlock(TestCase):
    ...
    def test_get_handler_class_raises_AttributeError_for_unset_handler_meta(
        self,
    ):  # noqa
    ...
    def test_get_handler_class_returns_load_class_with_handler_path(
        self, mock_import
    ):  # noqa
