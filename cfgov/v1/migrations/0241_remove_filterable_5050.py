# Generated by Django 3.2.18 on 2023-05-17 21:10
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                (
                                    "no_posts_message",
                                    wagtail.blocks.CharBlock(
                                        help_text='Message for the <a href="https://cfpb.github.io/design-system/components/notifications#default-base-notification">notification</a> that will be displayed instead of filter controls if there are no posts to filter.',
                                        required=False,
                                    ),
                                ),
                                (
                                    "no_posts_explanation",
                                    wagtail.blocks.CharBlock(
                                        help_text="Additional explanation for the notification that will be displayed if there are no posts to filter.",
                                        required=False,
                                    ),
                                ),
                                (
                                    ...
                                    wagtail.blocks.CharBlock(
                                        help_text="Strongly encouraged to help users understand the action that the date of the post is linked to, i.e. published, issued, released.",
