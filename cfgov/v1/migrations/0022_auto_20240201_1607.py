        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("email_signup", v1.blocks.EmailSignUpChooserBlock()),
                    (
                        "simple_chart",
                        wagtail.blocks.StructBlock(
                            [
                            ...
                            [
                                ...
                                (
                                    ...
                                    wagtail.blocks.ChoiceBlock(
                                        choices=[
                                            ...
                                            (
                                                "line",
                                                "Line | millions/billions y-axis values",
                                            ),
                                            (
                                                "line-index",
                                                "Line-Index | integer y-axis values",
                                            ),
                                            (
                                                "tile_map",
                                                "Tile Map | grid-like USA map",
                                            ),
                                        ]
                                    ),
                                ),
                                (
                                    ...
                                    wagtail.blocks.ChoiceBlock(
                                        ...
                                        help_text='Chart\'s color scheme. See "https://github.com/cfpb/cfpb-chart-builder#createchart-options-".',
                                        required=False,
                                    ),
                                ),
                                (
                                    "data_source",
                                    wagtail.blocks.CharBlock(
                                        help_text='Location of the chart\'s data source relative to "https://files.consumerfinance.gov/data/". For example,"consumer-credit-trends/auto-loans/num_data_AUT.csv".',
                                        required=True,
                                    ),
                                ),
                                (
                                ...
                                (
                                    ...
                                    wagtail.blocks.BooleanBlock(
                                        default=False,
                                        help_text="Check this to add a horizontal rule line to top of chart block.",
                                        required=False,
                                    ),
                                ),
                                (
                                ...
                                (
                                    "y_axis_label",
                                    wagtail.blocks.CharBlock(
                                        help_text="Custom y-axis label. NOTE: Line-Index chart y-axis is not overridable with this field!",
                                        required=False,
                                    ),
                                ),
                            ]
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                (
                                    ...
                                    wagtail.blocks.BooleanBlock(
                                        default=False,
                                        help_text="Check this box to allow the archival section to display. No section will appear if there are no archival downloads.",
                                        required=False,
                                    ),
                                )
                            ]
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                (
                                    "image",
                                    wagtail.images.blocks.ImageChooserBlock(
                                        icon="image", required=False
                                    ),
                                ),
                            ]
                        ),
                    ),
                    ("job_listing_table", jobmanager.blocks.JobListingTable()),
                    (
                        "yes_checklist",
                        wagtail.blocks.StructBlock(
                            [
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                (
                                    "events",
                                    wagtail.blocks.ListBlock(
                                        v1.atomic_elements.tables.CaseDocketEvent,
                                        collapsed=True,
                                        min_num=1,
                                    ),
                                )
                            ...
                            [
                                ...
                                (
                                    ...
                                    wagtailmedia.blocks.AbstractMediaChooserBlock(
                                        help_text='Spoken word audio files should be in MP3 format with a 44.1 kHz sample rate, 96 kbps (CBR) bitrate, in mono. See <a href="https://help.libsynsupport.com/hc/en-us/articles/360040796152-Recommended-Audio-File-Formats-Encoding">Libsyn’s guidance</a> for details. Note that the thumbnail and tag fields will not be used for audio files.'
                                    ),
                                ),
                                (
                                    "additional_details",
                                    wagtail.blocks.RichTextBlock(
                                        help_text="If you have anything you want to appear below the audio player, such as a download link, put it in this field.",
                                        required=False,
                                    ),
                                ),
                            ]
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                (
                                    "rows",
                                    wagtail.blocks.ListBlock(
                                        v1.atomic_elements.tables.ContactUsRow,
                                        collapsed=True,
                                        min_num=1,
                                    ),
                                ),
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    (
                        "reusable_text",
                        v1.blocks.ReusableTextChooserBlock("v1.ReusableText"),
                    ),
                ],
                use_json_field=True,
            ),
