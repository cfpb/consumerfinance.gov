...
class DataConverter(PageDataConverter):
    ...
    def add_defaults(self, doc, post_dict):
        ...
        post_dict.update({
            ...
            'sidefoot-0-value-relate_newsroom': u'on',
            'sidefoot-0-value-relate_events': u'on',
            ...
            'sidefoot-1-value-gd_code': u'USCFPB_23',
            ...
            'sidefoot-1-value-text': u'Subscribe to our email newsletter. We will update you on new newsroom updates.',
        })
