...
class TestActivityIndexPageSearch(TestCase):
    ...
    def test_search_page_get_template(self):
        ...
        self.assertEqual(
            ...
            'youth_activity_search/activity_index_page.html')
    ...
    def test_search_results_page_get_template(self):
        ...
        self.assertEqual(
            ...
            'youth_activity_search/activity_search_facets_and_results.html')  # noqa: E501
    ...
    @mock.patch('youth_activity_search.models.pages.SearchQuerySet.models')
