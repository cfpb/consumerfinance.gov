    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_duration', models.ForeignKey(to='youth_activity_search.ActivityDuration', on_delete=django.db.models.deletion.PROTECT)),
        ...
        migrations.AddField(
            ...
            name='activity_type',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityType'),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='age_range',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityAgeRange'),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='blooms_taxonomy_level',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityBloomsTaxonomyLevel'),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='building_block',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityBuildingBlock'),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='council_for_economic_education',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityCouncilForEconEd', blank=True),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='grade_level',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityGradeLevel'),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='handout_file',
        ...
        migrations.AddField(
            ...
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityJumpStartCoalition', blank=True),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='school_subject',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivitySchoolSubject'),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='special_population',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivitySpecialPopulation', blank=True),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='teaching_strategy',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityTeachingStrategy'),
        ),
        migrations.AddField(
            model_name='activitypage',
            name='topic',
            field=modelcluster.fields.ParentalManyToManyField(to='youth_activity_search.ActivityTopic'),
        ),
    ]
