...
from youth_activity_search.fields import ParentalTreeManyToManyField
from youth_activity_search.models import (
...
from youth_activity_search.molecules import YouthSearchHeroImage
...
class ActivityIndexPage(CFGOVPage):
    ...
    subpage_types = ['youth_activity_search.ActivityPage']
    ...
    def get_template(self, request):
        template = 'youth_activity_search/activity_index_page.html'
        if 'partial' in request.GET:
            template = 'youth_activity_search/activity_search_facets_and_results.html'  # noqa: E501
        return template
    ...
    class Meta:
        verbose_name = "Activity search page"
...
class ActivityPage(CFGOVPage):
    ...
    building_block = ParentalManyToManyField('youth_activity_search.ActivityBuildingBlock', blank=False)  # noqa: E501
    school_subject = ParentalManyToManyField('youth_activity_search.ActivitySchoolSubject', blank=False)  # noqa: E501
    topic = ParentalTreeManyToManyField('youth_activity_search.ActivityTopic', blank=False)  # noqa: E501
    # Audience
    grade_level = ParentalManyToManyField('youth_activity_search.ActivityGradeLevel', blank=False)  # noqa: E501
    age_range = ParentalManyToManyField('youth_activity_search.ActivityAgeRange', blank=False)  # noqa: E501
    student_characteristics = ParentalManyToManyField('youth_activity_search.ActivityStudentCharacteristics', blank=True)  # noqa: E501
    # Activity Characteristics
    activity_type = ParentalManyToManyField('youth_activity_search.ActivityType', blank=False)  # noqa: E501
    teaching_strategy = ParentalManyToManyField('youth_activity_search.ActivityTeachingStrategy', blank=False)  # noqa: E501
    blooms_taxonomy_level = ParentalManyToManyField('youth_activity_search.ActivityBloomsTaxonomyLevel', blank=False)  # noqa: E501
    ...
    jump_start_coalition = ParentalManyToManyField(
        'youth_activity_search.ActivityJumpStartCoalition',
        blank=True,
        verbose_name='Jump$tart Coalition',
    )
    council_for_economic_education = ParentalManyToManyField(
        'youth_activity_search.ActivityCouncilForEconEd',
        blank=True,
