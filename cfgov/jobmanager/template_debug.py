...
job_listing_json_ld_defaults = {
    'title': 'Director, Example Division',
    'description': 'This is a job description.',
    'responsibilities': 'These are the job responsibilities.',
    'offices': [washington_dc],
    'regions': [],
    'open_date': date(2099, 1, 1),
    'close_date': date(2100, 1, 1),
    'salary_min': 50000,
    'salary_max': 100000,
}


job_listing_json_ld_test_cases = {
    'Job in single office': {},
...
for job in job_listing_json_ld_test_cases.values():
    for k, v in job_listing_json_ld_defaults.items():
        job.setdefault(k, v)
