  ...
  ( function( $ ) {
    return $.widget( 'IKS.editHtmlButton', {
      ...
      populateToolbar: function( toolbar ) {
        ...
        const getEnclosing = function( tag ) {
          let node;
        ...
        button.on( 'click', function( event ) {
          $( 'body > .modal' ).remove();
          const contents = '<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">' +
          ...
          const modalBody = container.find( '.modal-body-body' );
          const bodyContents = '<textarea style="height: 400px; border: 1px solid black" id="wagtail-edit-html-content">' +
