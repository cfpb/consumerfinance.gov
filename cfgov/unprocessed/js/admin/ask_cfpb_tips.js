  ...
  ( function( jQuery ) {
    return jQuery.widget( 'IKS.answermodule', {
      ...
      populateToolbar: function( toolbar ) {
        ...
        buttonElement.Draftail - ToolbarButton( {
        ...
        buttonElement.on( 'click', function( event ) {
          ...
          const node = sel.baseNode || sel.anchorNode;
          const tip = $( node ).closest( '.' + baseClass )[0];
          ...
          if ( tip ) {
            ...
            while ( tip.firstChild ) {
              const child = tip.removeChild( tip.firstChild );
          ...
          if ( !range.canSurroundContents() ) {
            ...
            let start_depth = getDepth( common, range.startContainer );
            let end_depth = getDepth( common, range.endContainer );
            ...
            while ( !range.canSurroundContents() ) {
              ...
              } else if ( range.endContainer.classList.contains( textInputClass ) ) {
                break;
              } else {
        ...
        buttonset.Draftail - ToolbarButtonset();
