...
class TestConferenceRegistrationHandler(TestCase):
    ...
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.process_form')
    @mock.patch('data_research.handlers.ConferenceRegistrationForm')
    def test_process_cals_get_post_data_for_submitted_form(self, mock_form, mock_processform, mock_get_post_data):
    ...
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.process_form')
    @mock.patch('data_research.handlers.ConferenceRegistrationForm')
    def test_process_binds_form_for_submissions(self, mock_form, mock_processform, mock_get_post_data):
        data = {'post_data': None}
    ...
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.process_form')
    @mock.patch('data_research.handlers.ConferenceRegistrationForm')
    def test_process_calls_process_form_for_submissions(self, mock_form, mock_processform, mock_get_post_data):
        self.handler.process(is_submitted=True)
        mock_processform.assert_called_with(mock_form())

    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.get_post_data')
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.process_form')
    @mock.patch('data_research.handlers.ConferenceRegistrationForm')
    def test_process_does_not_bind_form_non_submissions(self, mock_form, mock_processform, mock_get_post_data):
    ...
    def test_process_form_calls_form_isvalid(self, mock_fail):
        form = mock.Mock()
        form.is_valid.return_value = False
        self.handler.process_form(form)
        self.assertTrue(form.is_valid.called)

    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.fail')
    def test_process_form_calls_calls_fail_for_invalid_form(self, mock_fail):
        form = mock.Mock()
        form.is_valid.return_value = False
        self.handler.process_form(form)
    ...
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.fail')
    def test_process_form_calls_subscribe(self, mock_fail, mock_subscribe):
        form = mock.Mock()
    ...
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.subscribe')
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.fail')
    def test_process_form_calls_fail_for_failed_subscribe(self, mock_fail, mock_subscribe):
        form = mock.Mock()
        mock_subscribe.return_value = False
        self.handler.process_form(form)
        mock_fail.assert_called_with(form)
    ...
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.subscribe')
    @mock.patch('data_research.handlers.ConferenceRegistrationHandler.fail')
    def test_process_form_calls_save_attendee_and_success_for_successful_subscription(self, mock_fail, mock_subscribe, mock_save_attendee, mock_success):
        form = mock.Mock()
    ...
    @mock.patch('data_research.handlers.messages')
    def test_sucess_calls_returns_JsonResponse_with_ajax_request(self, mock_messages, mock_json_response):
