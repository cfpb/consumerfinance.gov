# Generated by Django 2.2.13 on 2020-08-10 19:38
...
class Migration(migrations.Migration):
    ...
    replaces = [('data_research', '0011_recreated'), ('data_research', '0012_recreated_2'), ('data_research', '0013_auto_20200810_1456')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('json_value', django.contrib.postgres.fields.jsonb.JSONField(blank=True)),
                ('note', models.TextField(blank=True)),
                ('updated', models.DateField(auto_now=True)),
            ],
            options={
