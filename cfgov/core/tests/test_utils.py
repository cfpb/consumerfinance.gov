...
class FormatFileSizeTests(unittest.TestCase):
    ...
    def test_format_file_size_bytes(self):
        self.assertEqual(format_file_size(124), '124B')

    def test_format_file_size_one_kilobyte(self):
        self.assertEqual(format_file_size(1024), '1KB')

    def test_format_file_size_kilobytes(self):
        self.assertEqual(format_file_size(1024 * 900), '900KB')

    def test_format_file_size_megabytes(self):
        self.assertEqual(format_file_size(1024 * 9000), '9MB')

    def test_format_file_size_gigabytes(self):
        self.assertEqual(format_file_size(1024 * 9000000), '9GB')

    def test_format_file_size_terabytes(self):
        self.assertEqual(format_file_size(1024 * 9000000000), '8TB')
